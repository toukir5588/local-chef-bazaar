      ...
      <div className="mx-auto flex flex-col lg:flex-row justify-between w-full gap-12 py-10">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center gap-4 p-4 rounded-xl bg-yellow-50/50 border border-yellow-100">
            ...
            />
            <div>
              <div className="text-lg font-bold text-gray-800">Chef: {chefName}</div>
              <div className="text-sm text-gray-500 italic">{chefExperience}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="p-3 bg-gray-50 rounded-lg text-center">
              ...
              <p className="font-bold text-gray-800">🕒 {estimatedDeliveryTime}</p>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg text-center">
          ...
          <div className="flex justify-between items-center mt-auto">
            <div className="flex flex-col">
              ...
              <span className="font-extrabold text-4xl text-yellow-600">${price}</span>
            </div>
